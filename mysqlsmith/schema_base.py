...
from mysqlsmith.relmodel import SQLType, Table, Op, Routine, Scope, Column
from mysqlsmith.random_utils import random_pick, random_pick_iter


class Schema:
    def __init__(self):
        # Keep the grammar module name configurable so schema can decide which AST to instantiate.
        self.grammar_module: str = f"{__package__}.grammar"
